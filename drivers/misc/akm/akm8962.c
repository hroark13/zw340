...
#define AKM8962_DEBUG_MSG	0 //[ECID:000000] ZTEBSP wanghaifei disable debug message
...
//[ECID:000000] ZTEBSP wanghaifei 20120105 start, modify api adapt to new kernel
static long
akm_aot_ioctl(struct file *file,
			  unsigned int cmd, unsigned long arg)
//[ECID:000000] ZTEBSP wanghaifei 20120105 end, modify api adapt to new kernel
{
...
static struct file_operations akmd_fops = {
	...
	.unlocked_ioctl = akmd_ioctl,//[ECID:000000] ZTEBSP wanghaifei 20120105, modify api adapt to new kernel
};
...
static struct file_operations akm_aot_fops = {
	...
	.unlocked_ioctl = akm_aot_ioctl,//[ECID:000000] ZTEBSP wanghaifei 20120105, modify api adapt to new kernel
};
...
int akm8962_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	if (err < 0) {
		printk(KERN_ERR "akm8962 read chip id error!");
		remove_compass = 1;
	}
	#if 0
	/* IRQ */
...
//[ECID:000000] ZTEBSP wanghaifei 20120101 start, modify exit sequence
	i2c_del_driver(&akm8962_driver);
	misc_deregister(&akm_aot_device);
	misc_deregister(&akmd_device);
//[ECID:000000] ZTEBSP wanghaifei 20120101 end, modify exit sequence
}

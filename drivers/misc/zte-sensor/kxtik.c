...
//[ECID:000000] ZTEBSP wanghaifei start 20120312, add enable flag
	if(enable) {
		kxtik_enable(tik);
		tik->enable = 1;
	} else {
...
//[ECID:000000] ZTEBSP wanghaifei end 20120312, add enable flag
...
//[ECID:000000] ZTEBSP wanghaifei 20120217 end, set poll time
	...
	#ifndef CONFIG_PROJECT_P865F02
//[ECID:000000] ZTEBSP wanghaifei 20120217 start, for enable
...
//[ECID:000000] ZTEBSP wanghaifei 20120217 end, for enable
       #endif

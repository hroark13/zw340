...
static struct msm_camera_i2c_reg_conf sp0a28_full_settings[] = {
	...
	//单通道间平滑阈值	
	{0x57,0x04},	//	;raw_dif_thr_outdoor
	{0x58,0x12},//0x0a	// ;raw_dif_thr_normal
	{0x56,0x12},//0x10	// ;raw_dif_thr_dummy
	...
	{0xe6,0x10},//0x08	// ;rangek_neg_normal
	...
	*/
    ...
    /** ZTE_MODIFY lvzhenzhong  mod for image transform, 2013.2.19*/
    //{0x31,0x10},    //0x70
    {0x31,0x70},
    /** ZTE_MODIFY lvzhenzhong  end*/
...
static struct msm_camera_i2c_reg_conf sp0a28_saturation[][9] = {
	{{0xfd, 0x00}, {0xd3, SP0A28_P0_0xd3 - 0x90}, {0xd4, SP0A28_P0_0xd4 - 0x90}, {0xd6, SP0A28_P0_0xd6 - 0x90}, 
	{0xd7, SP0A28_P0_0xd7 - 0x90}, {0xd8, SP0A28_P0_0xd8 - 0x90}, {0xd9, SP0A28_P0_0xd9 - 0x90}, 
	{0xda, SP0A28_P0_0xda - 0x90}, {0xdb, SP0A28_P0_0xdb - 0x90},}, /* SATURATION LEVEL0*/
...
static struct msm_camera_i2c_reg_conf sp0a28_antibanding[][25] = {
    /*ANTIBANDING 60HZ*/
    {
...
struct msm_sensor_v4l2_ctrl_info_t sp0a28_v4l2_ctrl_info[] = {
	...
	//add V4L2_CID_AUTO_WHITE_BALANCE & V4L2_CID_BRIGHTNESS
	{
...
/* [ECID:000000] ZTEBSP wangjianping, 20121116 added for camera id info, start */
static ssize_t camera_id_read_proc(char *page,char **start,off_t off,int count,int *eof,void* data)
{		 	
    int ret;
	
    unsigned char *camera_status = "FRONT Camera ID:SuperPix,SP0A28 0.3M";	
...
/* [ECID:000000] ZTEBSP wangjianping, 20121116 added for camera id info, end */
...
static int32_t sp0a28_sensor_power_down(struct msm_sensor_ctrl_t *s_ctrl)
{
	int32_t rc = 0;
	struct msm_camera_sensor_info *info = NULL;
    ...
    if(info->sensor_pwd)
    {
        rc = gpio_request(info->sensor_pwd, "sp0a28_pwdn");
        if (rc < 0)
        {
...
static struct msm_sensor_fn_t sp0a28_func_tbl = {
	...
	.sensor_power_down = sp0a28_sensor_power_down, //msm_sensor_power_down,
};

...
/*ZTEBSP yuxin add this file for Hynix RAW sensor Hi-542 kernel driver 2012.06.01 ++*/
...
/*ZTEBSP yuxin add for hi542 write preview and snapshot exp gain,2012.07.10 --*/
...
///////////////////////////////////////////
	...
	{0x0011, 0x04}, //00}, exposure method change
...
static struct msm_camera_i2c_reg_conf hi542_recommend_settings[] = {
    ...
    {0x0011,0x94},//90}, //exposure method change
...
{		 	
    ...
    unsigned char *camera_status = "BACK Camera ID:HI542-5.0M";	
...
/*ZTEBSP yuxin add for hi542 gpio init,2012.08.28 ++*/
			...
			int update_type, int res)
{
	...
	if (update_type == MSM_SENSOR_REG_INIT) {
		...
		printk("%s:PERIODIC : %d,csi_config now is %d\n",__func__, res,csi_config);
		if (!csi_config) {

...
/*ZTEBSP yuxin add for PRJ P825A10 use adp1655 flash chip,2012.05.08 ++*/
...
int camera_flash_set_led_state(unsigned led_state, uint8_t curr_y)
{
	...
	case MSM_CAMERA_LED_LOW:
		...
		break;
	/* ZTE: added by yangchunni for flash torch mode 20110913 -- */
...
#if 0
/*ZTEBSP yuxin add for PRJ P825A10 use adp1655 flash chip,2012.05.11 ++*/
#ifdef CONFIG_ZTE_CAMERA_SOC_FLASH
...
#endif //CONFIG_ZTE_CAMERA_SOC_FLASH
/*ZTEBSP yuxin add for PRJ P825A10 use adp1655 flash chip,2012.05.11 --*/
#endif

...
/*ZTE BSP doumingming 20120924 modify for give enough time to topper's processing END */
	...
	//\B3\E4\B5\E7\C6\F7\B2\E5\B0θı\E4
	//if(!read_otg_flag())
	{
	...
	//\C8\E7\B9\FB\B5\E7\B3ص\E7ѹΪ0
	//ʯ\EC\CD\D0޸İ\CE\CF³\E4\B5\E7\C6\F7\BA\F3\B5\E7\B3ص\E7ѹ\B2\C9\D1\F9\B2\BB\B1\E4\B5\C4\CE\CA\CC\E2
	//if (!battery_voltage) 
	{
		#if 0
		if (charger_status == CHARGER_STATUS_INVALID) 
...
//				printk("shiyan:  chg_final_time =%d min  chg_time=%d min \n",  chg_final_time, chg_time);
			...
			else
			{
				...
				//\B3\E4\B5粻\BB\E1\CF½\B5
				 ...
				 {
					//ÿ1\B7\D6\D6ӳ\E4\B5\E7: 900mA x 1min = 15mAh  =0.44%  x 3400mAh
					//ÿ1\B7\D6\D6\D3\C9\CF\C9\FD1%
...
//		printk("doumingming:charge_flag=2 %d\n", charge_flag);
		...
		if(0 == batt_has_charged_full )
		{
			...
			//\B2\BB\D4\CA\D0\ED\CF½\B5\BAܶ\E0
			if ((last_battery_capacity != 1000)&&(batt_cap < last_battery_capacity))
			{
				//\C8\E7\B9\FB\CAǴ\FD\BB\FA\BAܳ\A4ʱ\BC\E4\BA\F3\BB\BD\D0ѣ\ACֱ\BDӸ\FC\D0\C2
				if(batt_cap_resume)
				{
					//batt_cap = last_battery_capacity - 1;
					batt_cap_resume =0;
				...
				{
					//ÿ1\B7\D6\D6ӷŵ\E7: 700mA x 1min = 11mAh  =0.3%  x 3400mAh
					//\D7\EE\B6\E0ÿ2\B7\D6\D6\D3\CF½\B51%
					//\B5\CD\D3\DA8%ʱÿ1\B7\D6\D6\D3\CF½\B51%
		...
		//\C8\E7\B9\FB֮ǰ\B3\E4\B5\E7\CD\EA\B3ɣ\AC\B2\A2\C7Ҵ\F3\D3\DA4080mv,\C9ϱ\A8\C2\FA\B8\F1
		else
		{
			batt_cap = 100;
		}
